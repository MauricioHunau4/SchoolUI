...
const rows = [
  ...
  CreateDataForProfessor('Lawrence Beck', 'Math', 7.5, "2022-06-06", 102, ""),
  CreateDataForProfessor('Heather Vasquez', 'Math', 7.5, "2022-06-06", 102, "Test for the comments"),
  CreateDataForProfessor('Samuel Roberts', 'Math', 7.5, "2022-06-06", 102, "Test for the comments"),
  CreateDataForProfessor('David Shelton', 'Math', 7.5, "2022-06-06", 102, "Test for the comments"),
  CreateDataForProfessor('Brett Murray', 'Math', 7.5, "2022-06-06", 101, ""),
  CreateDataForProfessor('Jessie Sanders', 'Math', 7.5, "2022-06-06", 102, ""),
  CreateDataForProfessor('James States', 'Math', 7.5, "2022-06-06", 101, ""),
  CreateDataForProfessor('Anderson Ryan', 'Math', 1403500365, "2022-08-06", 103, ""),
  CreateDataForProfessor('Aubree Crawford', 'Math', 60483973, "2022-08-06", 104, ""),
  CreateDataForProfessor('Sylvia Crawford', 'Math', 327167434, "2022-08-06", 104, "Test for the comments"),
  CreateDataForProfessor('Andrea Palmer', 'Math', 37602103, "2022-08-06", 103, "Test for the comments"),
  CreateDataForProfessor('Russell Castillo', 'Math', 35475400, "2022-08-06", 103, "Test for the comments"),
  CreateDataForProfessor('Melanie Thomas', 'Math', 83019200, "2022-06-06", 102, "Test for the comments"),
  CreateDataForProfessor('Everett Harvey', 'Math', 4857000, "2022-06-06", 103, "Test for the comments"),
  CreateDataForProfessor('Rebecca Howard', 'Math', 4857000, "2022-06-06", 103, ""),
  CreateDataForProfessor('Violet Stanley', 'Math', 4857000, "2022-06-06", 103, ""),
  CreateDataForProfessor('Lawrence Beck', 'Math', 126577691, "2022-05-10", 102, ""),
  CreateDataForProfessor('Heather Vasquez', 'Math', 126317000, "2022-05-10", 101, ""),
  CreateDataForProfessor('Samuel Roberts', 'Math', 67022000, "2022-05-10", 102, "Test for the comments"),
  CreateDataForProfessor('Jessie Sanders', 'Math', 67545757, "2022-05-10", 102, "Test for the comments"),
  CreateDataForProfessor('Brett Murray', 'Math', 146793744, "2022-05-10", 101, "Test for the comments"),
  CreateDataForProfessor('James States', 'Math', 200962417, "2022-05-10", 101, "Test for the comments"),
  CreateDataForProfessor('Anderson Ryan', 'Math', 210147125, "2022-09-10", 103, "Test for the comments"),
  CreateDataForProfessor('Aubree Crawford', 'Math', 126317000, "2022-09-10", 104, ""),
  CreateDataForProfessor('Sylvia Crawford', 'Math', 67022000, "2022-09-10", 104, ""),
  CreateDataForProfessor('Stanley Hughes', 'Math', 67545757, "2022-09-10", 104, ""),
  CreateDataForProfessor('Pamela Harvey', 'Math', 146793744, "2022-09-10", 104, ""),
  CreateDataForProfessor('Glen Cole', 'Math', 200962417, "2022-05-10", 104, "Test for the comments"),
  CreateDataForProfessor('Katie Herrera', 'Math', 210447125, "2022-09-10", 104, "Test for the comments"),
];
